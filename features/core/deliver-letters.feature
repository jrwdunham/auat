...
Feature: PDF Letter Delivery
  ...
  @deliver-ar-op-cons-letters @template.template_key.<template_key>
  ...
  @deliver-ar-gen-cons-letters @template.template_key.<template_key>
  ...
  @deliver-tnc-cons-letters @template.template_key.<template_key>
  ...
  @deliver-miscellaneous-letters @template.template_key.<template_key>
